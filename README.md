...
2. XHMM software : http://atgu.mgh.harvard.edu/xhmm/tutorial.shtml. You can consult the XHMM standard workflow by this website.In the downloaded and uncompressed folder `statgen-xhmm-*sources/scripts`, `interval_list_to_pseq_reg` command will be used.<br />
